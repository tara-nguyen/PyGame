...
class Player(np.Game):
    ...
    NonplayerClass. It's also the parent class of Goalkeeper and Outfielder.
    Player has the following methods:
        ...
        getCorners, getRotation, getBodyAngle, getFootAngle,
        setMovingRotation, getMovingRotation, getDistMoved,
        getDistToBall, getEnding, feetToFront, move, chooseKickingFoot,
    ...
    def setFootStartPos(self):
        ...
        self.betweenFeet = 8
        self.lFootStartPos = (
            self.bodyCenterPos[0]-self.getCenter()[0][0]*2-self.betweenFeet/2,
            self.bodyStartPos[1]+2)
        self.rFootStartPos = (self.bodyCenterPos[0]+self.betweenFeet/2,
                              self.lFootStartPos[1])
    ...
    def adjustFootStartPos(self):
        ...
        moveX, moveY = self.getDistMoved(newBodyCenterPos)
    ...
    def getCenter(self):
        ...
        footCenter = self.lFoot.get_rect().center
        bodyCenter = self.body.get_rect().center
        return footCenter, bodyCenter
    ...
    def updateFeet(self, foot, newCenterPos, rotate):
        ...
        newCenterPos is a tuple/list of the new coordinates of the
        center of each foot.
